...
- [Функциональность Charles Proxy](#функциональность-charles-proxy)
  - [Включение SSL Proxying (Контекстное меню)](<#включение-ssl-proxying-(контекстное-меню)>)
    - [📌Focus](#📌focus)
    - [📌SSL Proxying](#📌ssl-proxying)
    - [Дополнительный функционал](#дополнительный-функционал)
      - [Breakpoints (Перехват всех запросов с возможностью изменить)](<#breakpoints-(перехват-всех-запросов-с-возможностью-изменить)>)
      - [Repeat](#repeat)
      - [Repeat Advanced](#repeat-advanced)
  - [Proxy](#proxy)
    - [SSL Proxying Settings…](#ssl-proxying-settings…)
    - [📌Breakpoint Settings… (Перехват конкретного запроса с возможностью изменить)](<#📌breakpoint-settings…-(перехват-конкретного-запроса-с-возможностью-изменить)>)
    - [Throttle Settings](#throttle-settings)
    - [Reverse Proxies](#reverse-proxies)
    - [Por Forwarding](#por-forwarding)
    - [Windows Proxy](#windows-proxy)
  - [Tools](#tools)
    - [Map Local (Перехват конкретного запроса и подменой из файла)](<#map-local-(перехват-конкретного-запроса-и-подменой-из-файла)>)
    - [📌Rewrite](#📌rewrite)
...
На Рисунке 2.1.1 окно установки Charless. По умолчанию отмечен чекбокс запуска приложения, после окончания инсталяции, остовляем его отмеченым и нажимаем установить.
 ...
 <figure align="center">
  ...
  <figcaption>Рисунок 2.1.1</figcaption>
</figure>
...
<figure align="center">
  ...
  <figcaption >Рисунок 2.2.1</figcaption>
</figure>
...
<figure align="center">
  ...
  <figcaption >Рисунок 2.2.2</figcaption>
</figure>
...
<figure align="center">
  ...
  <figcaption >Рисунок 2.2.3</figcaption>
</figure>
...
<figure align="center">
  ...
  <figcaption >Рисунок 2.2.4</figcaption>
</figure>
...
<figure align="center">
  ...
  <figcaption >Рисунок 2.2.5</figcaption>
</figure>
...
### **Включение SSL Proxying (Контекстное меню)**
...
##### **Breakpoints (Перехват всех запросов с возможностью изменить)**
...
#### **📌Breakpoint Settings… (Перехват конкретного запроса с возможностью изменить)**
...
#### **Map Local (Перехват конкретного запроса и подменой из файла)**
